...
typedef struct ProFrameData_Unit//接收到的透传数据包
{
...
extern unsigned char  RecBuff[160];
extern unsigned char i;

extern unsigned char Activation_Ack;//激活成功为1
extern unsigned char GetControl_Ack;
